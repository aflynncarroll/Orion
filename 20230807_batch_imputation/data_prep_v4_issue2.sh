...
#
    ...
    plink --file "${file_loc}/${bfile_name}" --fam --keep-allele-order --within "${file_loc}/${bfile_name}".fam --hardy --out fam_ids
...
##### inputs
file_loc="/geschwindlabshares/HumanGenotypeArray/AGRE.ILMN.Omni/2017-9154/plinkable.HM_fwd"
# this is directory path to the original plink files
workdir="/home/aflynn/projects/20230807_batch_imputation/2017-9154_merge_clean190118"
# this is the directory where all the files will be stored - it is a created subdirectory of 
# 2nd input
bfile_name="2017-9154_merge_clean190118"
