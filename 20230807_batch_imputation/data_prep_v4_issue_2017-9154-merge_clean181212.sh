...
##### inputs
file_loc="/geschwindlabshares/HumanGenotypeArray/AGRE.ILMN.Omni/2017-9154-RPT/plinkable.HM_fwd_re-export"
# this is directory path to the original plink files
workdir="/home/aflynn/projects/20230807_batch_imputation/2017-9154-merge_clean181212"
# this is the directory where all the files will be stored - it is a created subdirectory of 
# 2nd input
bfile_name="2017-9154-merge_clean181212"
...
awk '{gsub(/_/,"vv",$1); gsub(/_/,"vv",$2); print}' "${workdir}/hg19_plink/${bfile_name}.fam" > "${workdir}/hg19_plink/${bfile_name}.fam.temp" && mv "${workdir}/hg19_plink/${bfile_name}.fam.temp" "${workdir}/hg19_plink/${bfile_name}.fam"
# added to replace _ with vv in the individual and family ids of a few individuals
...
python2 /home/aflynn/projects/20230628_TOPMed_Imputation_tools/checkVCF/checkVCF.py -r $hg38_fasta -o out /home/aflynn/projects/20230807_batch_imputation/2010-002.clean101007/hg38_upload_vcf/2010-002.clean101007-updated-chr1.vcf.gz

zcat /home/aflynn/projects/20230807_batch_imputation/2010-002.clean101007/hg38_upload_vcf/2010-002.clean101007-updated-chr1.vcf.gz | cut -f-8

zgrep '37476564' /home/aflynn/projects/20230807_batch_imputation/2010-002.clean101007/hg38_upload_vcf/2010-002.clean101007-updated-chr1.vcf.gz

vim /geschwindlabshares/HumanGenotypeArray/AGRE.ILMN.Omni/2010-002.reclustered/plinkable.HM.fwd/2010-002.clean101007.bim